<div>
        ...
        <div>
            ...
            <input type="radio" id="m" name="sexo_rdo" placeholder="Tu sexo" value="M" 
            <?php if($registro_contacto["sexo"]=="M"){echo "checked";} ?>  required>&nbsp;<label for="m">Masculino</label>

            &nbsp;&nbsp;&nbsp;

            <input type="radio" id="f" name="sexo_rdo" placeholder="Tu sexo" value="F" 
            <?php if($registro_contacto["sexo"]=="F"){echo "checked";} ?> required>&nbsp;<label for="f">Femenino</label>
        </div>

        <div>
            <label for="nacimiento">Fecha de Nacimiento: </label>
            <input type="date" name="nacimiento_txt" id="nacimiento" class="cambio" title="Tu cumple" value="<?php echo $registro_contacto["nacimiento"];?>" required>
        </div>
